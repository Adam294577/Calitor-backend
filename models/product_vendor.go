...
type ProductVendor struct {
	...
	VendorID          int64   `gorm:"not null;uniqueIndex:idx_product_vendor" json:"vendor_id"`
	...
	Wholesale         float64 `gorm:"type:numeric(18,2)" json:"wholesale"`
	WholesaleDiscount float64 `gorm:"type:numeric(5,2)" json:"wholesale_discount"`
